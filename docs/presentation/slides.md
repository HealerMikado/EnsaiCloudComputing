...
4. [Stocker des données dans le Cloud]({{ site.baseurl }}{% link docs/presentation/cloud-computing-CM4.html %})
5. [Faire une API dans le Cloud]({{ site.baseurl }}{% link docs/presentation/cloud-computing-CM5.html %})
